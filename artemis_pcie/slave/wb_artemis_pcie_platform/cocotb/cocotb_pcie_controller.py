...
class CocotbPCIE (object):
    ...
    def __init__(self, dut, debug = False):
        ...
        self.axm = AXIStreamMaster(self.dut.s1.api.pcie_interface, 'm_axis_rx', self.dut.s1.api.pcie_interface.user_clk_out)
        self.axs = AXIStreamSlave (self.dut.s1.api.pcie_interface, 's_axis_tx', self.dut.s1.api.pcie_interface.user_clk_out)
